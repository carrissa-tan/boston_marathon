...
test_selection = st.multiselect("test user selection: ", options = ['amanda', 'chan', 'sucks'])
...
#
#"""
#initilise repo using ctrl + shift + P
#add remote (using the git repo that you created) ctrl + shift + P
#stage, commit, push
#
#
#